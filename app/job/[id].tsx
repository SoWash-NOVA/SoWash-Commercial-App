...
//
// The SLD walkthrough (has_sld_walkthrough) is Phase 4; the flat photo grid
// below is the fallback that ships first.
...
import { useJobDetail, formatDateOnly, formatDateTime, statusMeta, stageIndex, STAGES } from '../../src/hooks';
